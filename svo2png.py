...
#            svo_image_sbs_rgba[0:height, 0:width, :] = left_image.get_data()
            ...
            video_writer.write(ocv_image_sbs_rgb)
                ...
                # Write image to png
            file_name = "data/"+str(Path(sys.argv[1])) + str(i) + ".png"
            cv2.imwrite(file_name, ocv_image_sbs_rgb)
            i += 1
            #video_writer.write(right_image.get_data())#           else:
                # Generate file names
